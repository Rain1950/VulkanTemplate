...
void GraphicsPipelineManager::CreateUniformBuffers(VkDevice& device,VkPhysicalDevice& physicalDevice, int MAX_FRAMES_IN_FLIGHT)
{
...
VkImageView GraphicsPipelineManager::CreateImageView(VkDevice& device, VkImage image, VkFormat forrmat)
{
